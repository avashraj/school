...
char *str2 = "Contents of new array containing even elements from original: "; char *str3 = "Contents of new array containing odd elements from original: ";
...
void arrCopy(){
	// Your code here
  int* arrEvenStart = arr_even;
  int* arrOddStart = arr_odd;
  int* arrStart = arr;
  for (int i = 0; i < size; i++) {
    if (*arr % 2 == 0) {
       *arr_even = *arr;
...
int main(){
    ...
    // Your code here
    char message[] = "Enter array element #";
    for (i = 0; i < size; i++) {
